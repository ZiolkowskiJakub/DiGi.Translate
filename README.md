...
**DiGi.Translate** is a C# engineering and architectural software library suite designed for BIM and CAD integrations (such as Revit, RhinoCommon, Grasshopper, and Dynamo BIM).
...
* **[DiGi.Translate.Framework.Application](DiGi.Translate.Framework.Application)** (Path: `DiGi.Translate\DiGi.Translate.Framework.Application`)
* **[DiGi.Translate.Framework](DiGi.Translate.Framework)** (Path: `DiGi.Translate\DiGi.Translate.Framework`)
* **[DiGi.Translate.WPF.Application](DiGi.Translate.WPF.Application)** (Path: `DiGi.Translate\DiGi.Translate.WPF.Application`)
* **[DiGi.Translate.WPF](DiGi.Translate.WPF)** (Path: `DiGi.Translate\DiGi.Translate.WPF`)
* **[DiGi.Translate](DiGi.Translate)** (Path: `DiGi.Translate\DiGi.Translate`)
